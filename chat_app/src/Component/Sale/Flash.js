...
const data = [
    ...
    { id: 5, fl_title: "Kinh Tế", fl_imgURL: "https://cdn0.fahasa.com/media/wysiwyg/icon-menu/ico_kinhte.png" },
]
function Flash() {
    return (
        <React.Fragment>
            {
                data.map(x => <Col style={{ textAlign: "center", margin: '10px 0' }} md={2} sm={4} xs={6}>
                    <img
                        src={x.fl_imgURL}
                        style={{ width: 50 }}
                        alt="..."
