        ...
        <Row style={{marginTop:20,background:'#fff',padding:20}}>
            <Col xs={4}>
                <div style={{display:'flex',flexDirection:'column',borderRight:'1px solid #cecece'}}>
                    ...
                    <img src="https://cdn0.fahasa.com/skin/frontend/ma_vanese/fahasa/images/logo.png" style={{maxWidth:'100%'}}/>
                    </span>
            ...
            <Col xs={8}>
                ...
                <Row >
                    ...
                    <Col><img src="https://www.fahasa.com/media/wysiwyg/Logo-NCC/vnpost.png" width={120}/></Col>
                    <Col><img src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/momopay.png" width={70}/></Col>
                    <Col><img src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/ZaloPay-logo-130x83.png" width={120}/></Col>
                    <Col><img src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/shopeepay_logo.png" width={120}/></Col>
                    <Col><img src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/logo_moca_120.jpg" width={70}/></Col>
                </Row>
            </Col>
